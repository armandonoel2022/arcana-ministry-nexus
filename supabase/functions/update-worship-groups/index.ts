    ...
    const groupsConfig: GroupConfig[] = [
      {
        ...
        members: [
          { fullName: 'Aleida Geomar Batista Ventura', voice: 'Soprano', role: 'Directora de Alabanza', micOrder: 1 },
          { fullName: 'Eliabi Joana Sierra Castillo', voice: 'Soprano', role: 'Corista', micOrder: 2 },
          { fullName: 'Félix Nicolás Peralta Hernández', voice: 'Tenor', role: 'Corista', micOrder: 3 },
          { fullName: 'Armando Noel Charle', voice: 'Tenor', role: 'Corista', micOrder: 4 },
          { fullName: 'Ruth Esmailin Ramirez', voice: 'Contralto', role: 'Corista', micOrder: 5 },
          { fullName: 'Fior Daliza Paniagua', voice: 'Contralto', role: 'Corista', micOrder: 6 },
        ],
      },
      {
        groupName: 'Grupo de Keyla',
        members: [
          { fullName: 'Keyla Yanira Medrano Medrano', voice: 'Soprano', role: 'Directora de Alabanza', micOrder: 1 },
          { fullName: 'Aida Lorena Pacheco De Santana', voice: 'Contralto', role: 'Corista', micOrder: 2 },
          { fullName: 'Yindhia Carolina Santana Castillo', voice: 'Soprano', role: 'Corista', micOrder: 3 },
          { fullName: 'Arizoni Liriano medina', voice: 'Bajo', role: 'Corista', micOrder: 4 },
          { fullName: 'Denny Alberto Santana', voice: 'Tenor', role: 'Corista', micOrder: 5 },
          { fullName: 'Sugey A. González Garó', voice: 'Contralto', role: 'Corista', micOrder: 6 },
        ],
      },
      {
        groupName: 'Grupo de Massy',
        members: [
          { fullName: 'Damaris Castillo Jimenez', voice: 'Soprano', role: 'Directora de Alabanza', micOrder: 1 },
          { fullName: 'Jisell Amada Mauricio Paniagua', voice: 'Soprano', role: 'Corista', micOrder: 2 },
          { fullName: 'Fredderid Abrahan Valera Montoya', voice: 'Tenor', role: 'Corista', micOrder: 3 },
          { fullName: 'Guarionex García', voice: 'Tenor', role: 'Corista', micOrder: 4 },
          { fullName: 'Rosely Montero', voice: 'Contralto', role: 'Corista', micOrder: 5 },
          { fullName: 'Rodes Esther Santana Cuesta', voice: 'Contralto', role: 'Corista', micOrder: 6 },
        ],
      },
    ];
