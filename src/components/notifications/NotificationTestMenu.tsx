...
const NotificationTestMenu = () => {
  ...
  const testBirthAnnouncement = () => {
    testNotification("nacimiento", {
      ...
      metadata: {
        ...
        baby_weight: "3.5 kg",
        baby_height: "50 cm",
        birth_message: "¡Damos gracias a Dios por esta bendición!",
        show_overlay: true,
      },
    });
  };
  ...
  const testPregnancyReveal = () => {
    testNotification("embarazo", {
      ...
      metadata: {
        ...
        due_date: "Agosto 2025",
        pregnancy_message: "¡Nos llena de alegría compartir esta noticia con nuestra familia ministerial!",
        show_overlay: true,
      },
    });
  };
  ...
  const testSpecialEvent = () => {
    testNotification("evento especial", {
      ...
      priority: 3,
      metadata: {
        event_name: "Culto Misionero",
        event_date: new Date().toISOString(),
        event_time: "10:00 AM",
        location: "Templo Principal",
        description: "Un tiempo especial para celebrar y apoyar las misiones de nuestra iglesia.",
        event_type: "worship",
        show_overlay: true,
      },
    });
