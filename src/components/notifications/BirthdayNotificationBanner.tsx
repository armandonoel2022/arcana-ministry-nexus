              ...
              <div>
                ...
                {notification.metadata.is_birthday_person ? (
                  <p className="text-pink-700 font-medium">
                    ¡
                    {(notification.metadata.birthday_member_name || notification.metadata.member_name)?.split(" ")[0] ||
                      "Amigo/a"}
                  ...
                  <p className="text-pink-700">
                    ...
                    ! Recuerda ir a la sala de chat general y dedicarle un mensaje de felicitación. ¡Hagamos que se
                    sienta especial en su día! ✨
                  </p>
                )}
              </div>
