        ...
        const channel = supabase
          ...
          .on(
            ...
            async (payload) => {
              ...
              // NO mostrar overlays automáticamente - las notificaciones push nativas se manejan en el sistema operativo
              // Los overlays solo se mostrarán cuando el usuario los active manualmente desde la página de notificaciones
              console.log("✅ [SYSTEM NOTIFICATIONS] Notificación registrada (push nativa enviada)");
            },
          )
          .subscribe((status) => {
